...
class Thatcamp_Registrations_Admin {
    ...
    function admin_menu() {
    	if ( function_exists( 'add_menu_page' ) ) {
    		add_submenu_page(__('THATCamp Registrations', 'thatcamp-registrations'), __('THATCamp Registrations', 'thatcamp-registrations'), 'manage-options', 'thatcamp-registrations', array($this, 'registrations_display'));
